...
void clean_up() {
    // Removal of shared memory happens here because the barber procese is
    // responsible for cleaning shared memories according to the task.
    if(semaphore_id != 0) {
...
void init(int argc, char** argv) {
    ...
    if (argc < 2) FAILURE_EXIT("Not enough arguments provided\n")
